...
object NeoKeys {
    val layer1 = mapOf (
        ...
        R.id.key_b1 to 'x', R.id.key_b2 to 'v', R.id.key_b3 to 'l', R.id.key_b4 to 'c', R.id.key_b5 to 'w', R.id.key_b6 to 'k', R.id.key_b7 to 'h', R.id.key_b8 to 'g', R.id.key_b9 to 'f', R.id.key_b10 to 'q', R.id.key_b11 to "ß",
